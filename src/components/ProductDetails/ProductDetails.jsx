                            ...
                            <div className="flex-1 py-2 px-3">
                                ...
                                <div className="flex flex-col gap-2 mb-4">
                                    ...
                                    <div className="flex items-baseline gap-2 text-3xl font-medium">
                                        <span className="text-gray-800">{product.price?.toLocaleString()} Birr</span>
                                        <span className="text-base text-gray-500 line-through">{product.cuttedPrice?.toLocaleString()} Birr</span>
                                    ...
                                    <div className="flex flex-col sm:flex-row justify-between">
                                        ...
                                        <div className="flex gap-16 mt-4 mr-6 items-stretch text-sm">
                                            ...
                                            <ul className="flex flex-col gap-2">
                                                ...
                                                <li>
                                                    <p className="flex items-center gap-3"><span className="text-primary-blue"><ShoppingCartCheckoutIcon sx={{ fontSize: "18px" }} /></span> Cash on Delivery available</p>
                                                </li>
                                            </ul>
                                        </div>
                                        {/* <!-- services details --> */}
