...
const Tender = ({ _id, name, images, ratings, numOfReviews, price, cuttedPrice }) => {
        ...
        <div className="flex flex-col items-start gap-2 px-4 py-6 relative hover:shadow-lg rounded-sm">
            ...
            <div className="flex flex-col gap-2 items-start">
                ...
                <div className="flex items-center gap-1.5 text-md font-medium">
                    ...
                    <span className="text-gray-500 line-through text-xs">{cuttedPrice?.toLocaleString()}Birr</span>
